...
#
# CONFIRMADO EMPIRICAMENTE (contra NQ1! real en vivo, TV con zona UTC-5
# Bogota): la vela 4H del domingo abre a las 17:00 (no a medianoche), y la
# vela Daily del domingo NO existe como vela propia -- se funde dentro de
# la vela del lunes (Fri 26 / Mon 29, sin Sun 28). Esta es la convencion
# correcta; NO usar anclaje a medianoche para 2H/4H/D/W.
...
#   - D               -> medianoche GMT-5 de la SESION (ver _session_close_dow).
#   - W               -> 00:00 del lunes en GMT-5 de la SESION.
# -----------------------------------------------------------------------------
sub _bucket_ts_for {
    my ($self, $ts, $tf) = @_;
    ...
    if ($tf eq 'D') {
        ...
        # TradingView para futuros CME (confirmado: domingo se funde en lunes).
