...
# EQH/EQL). ZigZag se calcula antes que SMC_Structures porque este ultimo lo
# usa como fuente de HH/HL/LH/LL (interno = detalle, externo = filtro de
# ruido -- ver comentario en SMC_Structures::_update_swing_structure).
